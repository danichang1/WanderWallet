const Footer = () => {
    return(
        <footer className="footer bottom-0 footer-center p-10 bg-base-300">
          <aside>
            ...
            <p className="font-bold">
              Wander Wallet <br/>Developed by Danielle Chang
            </p> 
            {/* fake email and phone number */}
            <p>wanderwallet@gmail.com</p>
            <p>(999)999-9999</p>
          </aside> 
          <nav>
            {/* social media symbols, don't link to anything */}
